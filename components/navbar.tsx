...
const NavBar=():ReactElement=>{
    ...
    return(
        <NavContainer>
            <Profile>
                <Link href="/"><ProfileImageContainer><ProfileImage src="/profile@64.jpg" srcSet="profile@64.jpg 64w, profile.jpg 414w" sizes="414px" alt="aravind reddy's image" /></ProfileImageContainer></Link>
                <ProfileText>
