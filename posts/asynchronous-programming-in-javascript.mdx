...
summary: " different approaches for asynchronous programming"
isPublished: true
---
...
![alt text](https://media.giphy.com/media/l1J9wZJLPywQuKovK/giphy.gif "promise")
...
5.This is a simple version of whats going inside the Promise so if you 
   ...
   statements. If you want to dive deeper look at [this article](https://levelup.gitconnected.com/understand-javascript- 
  promises-by-building-a-promise-from-scratch-84c0fd855720)
